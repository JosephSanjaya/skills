...
- Do use light-tinted backgrounds with 20px+ backdrop blur to achieve a glass effect.
- Don't use solid background colors for card containers on vibrant canvases.
- Do enforce a 1px white border at low opacity on all glass cards for edge definition.
- Don't apply dark drop shadows; use soft, color-tinted ambient shadows instead.
