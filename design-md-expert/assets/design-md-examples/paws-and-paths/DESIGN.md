...
- Do use rounded corners for card profiles to evoke approachability and safety.
- Don't crowd UI elements; use generous margins to maintain a clean layout.
- Do apply highly diffused and soft ambient shadows to imply depth.
- Don't use pure black (#000000) for body text; use deep charcoal for legibility.
