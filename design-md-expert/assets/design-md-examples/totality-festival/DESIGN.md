...
- Do pair Space Grotesk headings with Inter body copy to balance cinematic branding and reading legibility.
- Don't use heavy dark drop shadows; express depth via frosted glass cards with fine 1px strokes.
- Do apply tinted radial backdrops that simulate an eclipse corona.
- Don't use more than one call-to-action color per viewport.
