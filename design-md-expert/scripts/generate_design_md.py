...
class DesignMDGenerator:
    ...
    def generate(self) -> str:
        ...
        self.data['personality'] = self.prompt("Personality (3-5 adjectives)", "Professional, Modern, Clean")
...
"""
    ...
    def save(self, content: str, output_path: str):
        ...
        print(f"  2. Add more component specifications")
        print(f"  3. Test with AI agent: generate a sample component")
